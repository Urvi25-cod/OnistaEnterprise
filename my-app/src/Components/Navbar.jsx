...
//      <nav className="flex justify-between bg-white items-center px-4 py-5 mx-auto max-w-7xl  z-50 ">
//         <div className="flex justify-start">
//           <Link to={'/'}>
//             <img src={logo} alt="Logo" className="h-10 w-auto md:h-10 lg:h-20" />
//           </Link>
//         </div>
...
//           <a href="/Aboutpage" className="hover:text-gray-500">About</a>
...
//             </button>
//           </Link>
//           <button onClick={toggleLoginPopup} className="hover:text-gray-500 focus:outline-none">
//             <img src={users} alt="User" className="h-5 w-5" />
//           </button>
//           <button onClick={toggleSlider} className="md:hidden hover:text-gray-500 focus:outline-none">
//             {/* Hamburger Icon SVG */}
...
//       {/* Mobile Slider Menu */}
//       <div className={`fixed top-0 right-0 h-full w-full bg-white shadow-lg z-30 transform transition-transform duration-300 ease-in-out ${isSliderOpen ? 'translate-x-0' : 'translate-x-full'}`}>
//         <button
//           onClick={toggleSlider}
    ...
    <>
      ...
      <header className='bg-white top-0 sticky z-50'>
        <nav className="flex justify-between bg-white items-center px-4 py-5 mx-auto max-w-7xl">
          ...
          <div className="flex items-center space-x-6">
            ...
            <button onClick={toggleLoginPopup} className="hover:text-gray-500 focus:outline-none cursor-pointer ">
              <img src={users} alt="User" className="h-5 w-5" />
            </button>
      ...
      >
        ...
        <div className="mt-16 space-y-4 px-4">
          ...
          <Link to="/News" onClick={handleLinkClick} className="block hover:text-gray-500">News</Link>
          <Link to="/Contact" onClick={handleLinkClick} className="block hover:text-gray-500">Contact</Link>
          <Link to="/CustomizeProduct" onClick={handleLinkClick} className="block hover:text-gray-500">Customize Product</Link>
        </div>
      </div>
